...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <table class="table table-hover table-striped table-sm">
      ...
      <tbody>
        <tr>
          <td><input class="form-control form-control-sm" type="text" name=""></td>
          <td>21345</td>
          <td>2243TR</td>
          <td>Standard Lead</td>
          <td>€ 39.99</td>
          <td><a href="" class="btn btn-link btn-sm py-0" data-toggle="modal" data-target="#leaddetails"><i class="fas fa-trash-alt text-danger mr-2"></i></a></td>
        </tr>
        <tr>
          <td><input class="form-control form-control-sm" type="text" name=""></td>
          <td>21345</td>
    ...
    <div class="text-right">
      <a class="btn btn-primary btn-sm" href="lead/checkout.php" role="button">Pay now ››</a>
    </div>
  </div>
